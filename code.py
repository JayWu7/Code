...
def save_image(image, filename):
  ...
  plt.imsave(path, image, dpi=1200)
...
for file in os.listdir(images_folder):
  if file.endswith('.jpg'):
    image = os.path.join(images_folder, file)
    images_list.append(image)

def detect_img(image):
  # image_path = open_and_resize_image(image_url, 640, 480)
  print(image)
  run_detector(detector, image, save=True)


detect_img(images_list[1])
